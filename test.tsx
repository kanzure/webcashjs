...
test("convert decimal amount to string", () => {
    ...
    expect(decimalAmountToString(new Decimal("0.00000010"))).toBe("0.0000001");
});
...
test("secret and public webcash", () => {
    ...
    expect(() => new SecretWebcash(new Decimal("3.123456789"), "feedbeef")).toThrow(RangeError);
    expect(() => new PublicWebcash(new Decimal("3.123456789"), "feedbeef")).toThrow(RangeError);
});
...
test("processHealthcheckResults", () => {
    ...
    let results2 = {
        "e15.000:public:155191994c768836d5447b6e7897e27192829ec6ec8b725495a68b48c69e4236": {"spent": false, "amount": "15"},
        "e6:public:760779899e2386bc3b164aa3f56e4dea4d11bd95d4e5f755cb53da9c72c72bfe": {"spent": false, "amount": "6"},
    };
